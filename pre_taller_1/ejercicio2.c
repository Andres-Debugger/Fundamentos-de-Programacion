...
int main()
{
    ...
    total_menores=0, total_mayores=0, dia_actual=1, mes_actual=1, año_actual=0, total_descuent_mujer=0, total_descuent_hombre=0;
    char sexo;
    ...
    for(i=1; i<=cant_paciente; i++){
        ...
        while((año_actual-año) != edad){
            printf ("\nSu fecha de naciemiento no coincide con su edad, por favor introdusca el año correcto:\n");
            scanf("%d", &año);
        }
